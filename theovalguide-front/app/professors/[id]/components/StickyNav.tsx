        ...
        >
          <div className="relative">
            <input
              ...
              className="w-full rounded-full bg-card text-foreground border border-border
                         placeholder:text-muted-foreground pl-11 pr-28 py-2.5 text-sm shadow-sm
            ...
            <button
              type="submit"
              className="absolute right-1.5 top-1/2 -translate-y-1/2 rounded-full px-4 py-1.5 text-sm font-medium
                         bg-brand hover:bg-brand-darker text-[var(--brand-contrast)] focus:outline-none focus:ring-2 ring-brand"
            >
              Search
            </button>
          </div>
          ...
          <form onSubmit={(e) => e.preventDefault()}>
            <div className="relative">
              <input
                ...
                placeholder="Search professors, courses…"
                className="w-full rounded-full bg-card text-foreground border border-border
                           placeholder:text-muted-foreground pl-11 pr-24 py-2 text-sm
                           focus:outline-none focus:ring-1 ring-brand focus:border-[var(--brand)]"
              />
              <span className="pointer-events-none absolute left-4 top-1/2 -translate-y-1/2 text-muted-foreground">
                🔎
              ...
              <button
                type="submit"
                className="absolute right-1 top-1/2 -translate-y-1/2 rounded-full px-3 py-1 text-xs font-medium
                           bg-brand hover:bg-brand-darker text-[var(--brand-contrast)] focus:outline-none focus:ring-2 ring-brand"
              >
                Search
              </button>
